...
/**
 * The request object is a registry object that stores a sanitized copy of the user REQUEST and any responses generated by that request.
 * It is possible to pass the Request a mock REQUEST that overrides any of the default REQUEST values.
 */
class Request {
    /**
    ...
    /**
     * Personal set of sanitized properties stored by each instance of a request object.
     */
    protected $properties = array();
    
    /**
     * Personal set of unsanitized properties stored by each instance of a request object.
     */
     ...
     *                              - Constructs an instance from $_GET, named 'items', with obj::m->items; this request
     *                                object can be retrieved latter with Request::instance( 'Get', 'items')
     * 
    ...
    /**
     * Sanitizes the request array and assigns it to the internal value of the request.
    ...
    /**
     * Adds a response to the request. These would be (1) error messages and (2) success messages.
     * @param string $resp
     */
